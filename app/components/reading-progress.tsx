...
export function ReadingProgress() {
  ...
  return (
    <div className="fixed top-1/2 -translate-y-1/2 z-40 hidden lg:block" style={{ left: `${left}px` }}>
      <div className="w-0.5 h-32 bg-muted-foreground/30 rounded-full overflow-hidden">
        <div
